    ...
    <main class="about">
        <section class="hero">
            <div class="hero-content">
                <h2 class="text-[40px] font-extrabold" data-aos="zoom-in">A propos du GROUPE M'VOLAIS</h2>
            </div>
            </section>
            ...
            <div class="container">
                ...
                <p class="text-[18px] text-zinc-500 text-center	">Le GROUPE M'VOLAIS SARL est une société commerciale ivoirienne spécialisée dans la fourniture de pièce detaché ou distriution
...
La société a existé sous la forme juridique d'entreprise individuelle depuis janvier 2008 avant de muter en société à responsabilité limitée (SARL) en août 2011. C’est une société de droit ivoirien, fondée par des jeunes ivoiriens avec de longues années d'expériences acquises dans une multinationale de la place.</p>
                ...
                <div class="row">
                    ...
                    <div class="desc w-full p-2">
                        ...
                        <p class="text-[16px] text-zinc-500 text-center	">
            ...
            <div class="container">
                ...
                <div class="content-image w-[80%] mx-auto mt-2 h-[500px] relative">
